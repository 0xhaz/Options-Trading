...
import {TickPriceLib} from "src/libraries/TickPrice.sol";
...
contract TestVolumeTrackerHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        // Deploy the hook an address with the correct flags
        ...
        // this is done by computing x and y from the equation shown in Ticks and Q64.96 section
    ...
    function test_redeemInNarrativeControllerWithoutBuyBack() public {
    ...
    function test_redeemInNarrativeControllerWithBuyBack() public {
        assertEq(hook.isOptionTokenValid(1), true);
